...
type SingleCourseInWishListProps = {
    course: ICourseDetails
    onClick?: ()=> void
}


const SingleCourseInWishList: React.FC<SingleCourseInWishListProps> = ({ course, onClick}) => {
    return (
        <li>
                    ...
                    <div className='flex flex-col justify-between md:gap-1 w-full'>
                        <div className='flex flex-row justify-between'>
                            <div className='flex flex-col gap-3'>
                                ...
                                <span className='text-sm text-light_secondary_text dark:text-dark_secondary_text'>{(course.enrolledCount && course.enrolledCount < 100) ? "Below 100 Enrolls" : (course.enrolledCount && course.enrolledCount >= 100 ) && course.enrolledCount < 500 ? "100+ Enrolls" : "500+ Enrolls"}</span>
                            </div>
                            <div>
...
export default SingleCourseInWishList