...
const SingleUnpublishedCourse: React.FC<SingleUnpublishedCourseProps> = ({count}) => {
    return (
        <li>
            <div className='w-full p-4 mt-5 h-[120px] rounded-md bg-light_secondary_bg dark:bg-dark_secondary_bg'>
                <div className='flex gap-5'>
                    ...
                    <div className='flex flex-col'>
                        <span className='text-md lg:text-lg text-light_primary_text dark:text-dark_primary_text'>Course name</span>
                        <span className='text-sm lg:text-md text-light_secondary_text dark:text-dark_secondary_text'>Field of study</span>
                    </div>
                </div>
            </div>
        </li>
