...
const Timeline: React.FC = () => {
    return (
        <div>
            <div className='mb-8 md:mb-16 '><span className='text-2xl md:text-5xl font-semibold text-light_primary dark:text-dark_primary'>Announcements</span></div>
            <ol className="relative border-l border-gray-200 dark:border-gray-700">
                <li className="mb-10 ml-6">
                    <span className="absolute flex items-center justify-center w-6 h-6 bg-blue-100 rounded-full -left-3 ring-8 ring-white dark:ring-gray-900 dark:bg-blue-900">
                        <TfiAnnouncement className="text-light_primary_btn_text dark:text-dark_primary_btn_text" />
                    </span>
